                ...
                transl_pat (fun cur_state3 term_pattern binders ->
                  transl_term (fun cur_state4 term_pat_left term_pat_right ->
                    ...
                    transl_both_side_succeed (fun cur_state5 ->
                      let (hypothesis,hyp_tags) =
                        let fact1 = mess_fact cur_state5.cur_phase channel_left term_pat_left channel_right term_pat_right in
                        let tag1 = InputTag occ in
                        if occ.precise || Param.get_precise()
                        then
                          begin
                            ...
                            Reduction_helper.add_precise_info_occ occ precise_info;
                            add_in_precise_actions ev;
                            (fact1::Pred(Param.begin2_pred,[FunApp(ev,[occ_name;term_pat_left]);FunApp(ev,[occ_name;term_pat_right])])::cur_state5.hypothesis,
                            tag1  :: PreciseTag(occ) :: cur_state5.hyp_tags
                            )
                          end
                        else
                          (fact1::cur_state5.hypothesis, tag1::cur_state5.hyp_tags)
                      in
                      ...
                      then
                        begin
                          ...
                          output_rule { cur_state5 with
                            ...
                            hypothesis = (mess_fact cur_state5.cur_phase channel_left term_pat_left channel_right x_right)::cur_state5.hypothesis;
                          ...
                          output_rule { cur_state5 with
                            ...
                            hypothesis = (mess_fact cur_state5.cur_phase channel_left x_left channel_right term_pat_right)::cur_state5.hypothesis;
                            hyp_tags = TestUnifTag2(occ)::(InputTag occ)::cur_state5.hyp_tags
                          } (Pred(Param.bad_pred, []))
                        end
