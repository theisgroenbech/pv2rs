...
lib:
  ...
  | SET IDENT EQUAL INT DOT lib
      { (TSet($2,I $4)) :: $6 }
  | NOUNIF nevartype SEMI tfnebindingseq options DOT lib
      { (TNoUnif ($2, $4, $5)) :: $7 }
  | NOUNIF tfnebindingseq options DOT lib
      { (TNoUnif ([], $2, $3)) :: $5 }
...
|       EVENT LPAREN gformatseq RPAREN optphase optint
        { BFNoUnif((("event", parse_extent()),$3,$5), $6) }
