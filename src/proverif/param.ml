...
let allow_private_comm_on_public_free_names = ref true
...
(* For authenticity *)
let end_pred = { p_name = "end"; p_type = [event_type]; p_prop = 0; p_info = []; p_record = 0 }
let end_pred_inj = { p_name = "end"; p_type = [occurrence_type; event_type] ; p_prop = 0; p_info = []; p_record = 0 }
let end2_pred = { p_name = "end2"; p_type = [event_type;event_type]; p_prop = 0; p_info = []; p_record = 0 }

let begin_pred = { p_name = "begin"; p_type = [event_type]; p_prop = pred_BLOCKING; p_info = []; p_record = 0 }
let begin_pred_inj = { p_name = "begin"; p_type = [event_type;occurrence_type]; p_prop = pred_BLOCKING; p_info = []; p_record = 0 }
let begin2_pred = { p_name = "begin2"; p_type = [event_type;event_type]; p_prop = pred_BLOCKING; p_info = []; p_record = 0 }
...
let dummy_pred = { p_name = "dummy"; p_type = []; p_prop = 0; p_info = []; p_record = 0 }
...
let reset_param() =
  ...
  allow_private_comm_on_public_free_names := true;
  key_compromise := 0;
  ignore_types := NotSet;
